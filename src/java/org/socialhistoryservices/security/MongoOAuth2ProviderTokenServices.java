 ...
 */
final public class MongoOAuth2ProviderTokenServices extends RandomValueOAuth2ProviderTokenServices {
    ...
    private OAuth2Authentication clientAuthentication(Authentication userAuthentication) {
        AuthorizedClientAuthenticationToken clientAuthentication = new AuthorizedClientAuthenticationToken(clientId, clientSecret, scope, authorities);
