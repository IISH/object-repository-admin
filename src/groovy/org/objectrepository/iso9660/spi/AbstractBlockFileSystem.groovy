...
public abstract class AbstractBlockFileSystem<T extends FileEntry> extends AbstractFileSystem<T> {
    ...
    protected AbstractBlockFileSystem(final def file, final int blockSize,
    ...
    public final Iterator<T> iterator() {
        ...
        iterator(this.volumeDescriptorSet.getRootEntry())
    }
     ...
     *
     * @throws java.io.IOException if the number of bytes read into the buffer was less than the expected number (i.e. the block
     *                     size)
     */
