...
public class Constants {
     ...
     */
    static int DEFAULT_BLOCK_SIZE = 2 * 1024

    /**
     * The number of reserved sectors at the beginning of the file.
     */
    static int RESERVED_SECTORS = 16

    /**
     * The number of reserved bytes at the beginning of the file.
     */
    static int RESERVED_BYTES = RESERVED_SECTORS * DEFAULT_BLOCK_SIZE

    /**
     * Default character encoding.
     */
    static String DEFAULT_ENCODING = "US-ASCII"
}