...
<div id="show-files" class="content scaffold-show" role="main">
                ...
                <span class="property-value" aria-labelledby="files-label">
                    <g:each in="${orfileInstanceList}" var="orfileInstance">
                        <table style="text-align: left">
                            ...
                            <g:if test="${orfileInstance.metadata.pidUrl}">
                                <tr>
                                    <td><g:message code="file.pidurl" default="Persistent url"/></td>
                                    <td>
                                        <a href="${orfileInstance.metadata.pidUrl}" target="_blank">${orfileInstance.metadata.pidUrl}</a>
                                    </td>
                                </tr>
                            </g:if>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${master.metadata.pid.bytes.encodeBase64().toString()}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
