...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link mapping="namingAuthority" params="[na: params.na]" class="show" action="show"><g:message
                code="default.show.label" args="[entityName]"/></g:link></li>
    </ul>
</div>
...
<div id="download" class="content" role="main">
    <ol class="property-list profile">
        <li class="fieldcontain">Staging area fileSet: ${instructionInstance.fileSetAlias}/instruction.xml<br/><g:link
                ...
                id="${instructionInstance.id}">Place the instruction on the staging area where you can use ftp to download it.</g:link>
            <p>After selecting this option you will be taken directly back to the Instructions list.</p>
        </li>
        <li class="fieldcontain">Browser<br/>
            <g:link mapping="namingAuthority" params="[na: params.na, transport: 'http']" action="download"
